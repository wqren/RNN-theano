...
if __name__=='__main__':
    ...
    ## DEFAULT VALUES ##
    state['configfile'] ='/data/lisa/exp/pascanur/repos/RNN_theano/rnn001/RNN_forget.ini'
    state['jobman.experiment'] = 'RNN_forget.jobman'
    n_jobs = 0
    ...
    for n_jobs in xrange(150):
        ...
        state['nhid'] = numpy.random.randint(180)+3
        nhid = state['nhid']
        ...
        n = numpy.random.randint(2)
        if n == 0 :
            state['task_switches'] = 3
        elif n == 1:
            state['task_switches'] = 6
        #else:
        #    state['n_outs'] = 4
        ...
        state['name'] = 'rnnforget_%03d'%n_jobs
